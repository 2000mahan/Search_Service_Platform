...
def champion_lists_create(status, postings_list, positional_index):
    if not status:
...
def query(input_query):
    ...
    postings_list = champion_lists_create(champion_lists_status, postings_list, positional_index)
